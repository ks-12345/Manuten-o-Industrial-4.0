...
UserModel _userModelDeserialize(
  ...
  object.role =
      _UserModelroleValueEnumMap[reader.readStringOrNull(offsets[3])] ??
          UserRole.admin;
...
P _userModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (reader.readString(offset)) as P;
    case 3:
      return (_UserModelroleValueEnumMap[reader.readStringOrNull(offset)] ??
          UserRole.admin) as P;
    case 4:
      return (reader.readString(offset)) as P;
    default:
...
const _UserModelroleValueEnumMap = {
  ...
  r'technician': UserRole.technician,
};
